            ...
            <div className="space-y-6">
              ...
              >
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-fuchsia-500 to-purple-600 hover:from-fuchsia-600 hover:to-purple-700 text-white rounded-lg py-3 transition-colors font-medium py-4 rounded-xl disabled:opacity-50 disabled:cursor-not-allowed"
                >
