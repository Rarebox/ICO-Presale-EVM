  ...
  const megaMenus = {
    ecosystem: {
          ...
          links: [
            {
              ...
              label: "NextDrop AI",
              href: "https://NextDrop.gitbook.io/NextDrop",
            },
            {
              icon: <FiCpu className="text-indigo-500" />,
              label: "AIVM",
              href: "https://NextDrop.gitbook.io/NextDrop/NextDrop-docs/quickstart",
            },
            {
              icon: <FiLayers className="text-fuchsia-500" />,
              label: "Framework",
              href: "https://NextDrop.gitbook.io/NextDrop/NextDrop-docs",
            },
          ],
        },
        {
          ...
          links: [
            {
              ...
              label: "How To Buy",
              href: "https://NextDrop.gitbook.io/NextDrop/NextDrop-docs/publish-your-docs",
            },
            {
            ...
            },
            {
              ...
              label: "Create Wallet",
              href: "https://NextDrop.gitbook.io/NextDrop/NextDrop-docs/publish-your-docs/create-a-wallet",
            },
          ],
        },
        {
          ...
          links: [
            {
              ...
              href: "https://NextDrop.gitbook.io/NextDrop/tokenomics",
            },
            {
              icon: <FiBook className="text-fuchsia-500" />,
              label: "Referral",
              href: "https://NextDrop.gitbook.io/NextDrop/referral",
            },
            {
              icon: <FiCompass className="text-indigo-500" />,
              label: "Audits",
              href: "https://NextDrop.gitbook.io/NextDrop/audits",
            },
          ],
        },
      ],
      featuredBox: {
        ...
        description:
          "Be part of the NextDrop revolution and help shape the future of AI-driven blockchain.",
    ...
    resources: {
      ...
      columns: [
        {
          ...
          links: [
            ...
            },
            {
              ...
              label: "Import Token",
              href: "https://NextDrop.gitbook.io/NextDrop/import-token",
            },
            {
              icon: <FiBook className="text-fuchsia-500" />,
              label: "Documentation",
      ...
      featuredBox: {
        ...
        description:
          "Access developer resources and start building on the NextDrop Protocol.",
