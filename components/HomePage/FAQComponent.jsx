...
const FAQComponent = ({ isDarkMode }) => {
  ...
  const faqItems = [
    {
      question: "What is NextDrop AI and its core mission?",
      answer:
        "NextDrop AI is a cutting-edge blockchain ecosystem powered by artificial intelligence. Our mission is to revolutionize decentralized applications and governance through innovations like PoI Consensus, the Artificial Intelligence Virtual Machine (AIVM), and a Transparent AI Framework. We aim to create a smarter, more secure, and equitable blockchain ecosystem for all.",
    },
    {
      question: "What makes NextDrop AI’s PoI Consensus unique?",
      answer:
    ...
    {
      question: "What are the details of the NextDrop AI presale?",
      answer:
        "The NextDrop AI presale offers early adopters the opportunity to purchase tokens before the public launch. Participants benefit from discounted prices and exclusive perks, such as governance voting rights and priority access to ecosystem features like the Memecoin Launchpad.",
    },
    {
      question: "How does NextDrop AI ensure transparency in its ecosystem?",
      answer:
        "Our Transparent AI Framework ensures every AI decision-making process is auditable and explainable. By embedding accountability into the system, we foster trust and reliability, empowering users and developers to confidently interact with NextDrop AI’s technology.",
    },
    {
      question: "What role does decentralized governance play in NextDrop AI?",
      answer:
        "Decentralized governance is at the heart of NextDrop AI. Token holders can actively participate in decision-making processes, proposing and voting on key initiatives. This ensures the ecosystem evolves in alignment with community values while leveraging AI to streamline governance operations.",
    },
  ];
